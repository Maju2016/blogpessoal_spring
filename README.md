...
1. Clone o repositório do Projeto [Blog Pessoal](https://github.com/Maju2016/blogpessoal_spring.git) dentro da pasta do *Workspace* do STS
 
```bash
git clone https://github.com/Maju2016/blogpessoal_spring.git
```
