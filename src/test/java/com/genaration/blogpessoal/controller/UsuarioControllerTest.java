...
import com.genaration.blogpessoal.repository.UsuarioRepository;
import com.genaration.blogpessoal.service.UsuarioService;
import com.genaration.blogpessoal.util.JwtHelper;
import com.genaration.blogpessoal.util.TestBuilder;
...
public class UsuarioControllerTest {
	...
	@Test
	@DisplayName("03 - Deve Atualizar os dados do usuario")
	...
	void deveListarTodosUsuarios() {
		// Given
		usuarioService.cadastrarUsuario(TestBuilder.criarUsuario(null, "Ana", "ana@email.com.br", "12345678"));
		usuarioService.cadastrarUsuario(TestBuilder.criarUsuario(null, "Cintia", "cintia@email.com.br", "12345678"));
